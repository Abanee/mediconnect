# Generated by Django 4.2.7 on 2025-11-19 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultation_type', models.CharField(choices=[('video', 'Video'), ('chat', 'Chat'), ('in_person', 'In Person')], default='video', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialty', models.CharField(choices=[('cardiologist', 'Cardiologist'), ('neurologist', 'Neurologist'), ('pediatrician', 'Pediatrician'), ('dermatologist', 'Dermatologist'), ('orthopedic', 'Orthopedic'), ('general', 'General Physician')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('card', 'Card'), ('upi', 'UPI'), ('cod', 'Cash on Delivery')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='video_calls', to='api.appointment')),
            ],
        ),
        migrations.CreateModel(
